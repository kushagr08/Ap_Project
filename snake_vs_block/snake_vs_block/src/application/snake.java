...
public class snake extends Group {
	...
	public void turnleftorright(KeyEvent event,Wall wall) {
        ...
        if (event.getCode() == KeyCode.RIGHT) {
        	...
        	for (Object d:this.getChildren()) {
        		Circle ff= (Circle) d;
            	if(wall.getY()+200>=290 && wall.getY()<=390 && ((wall.getX()-headx<=10 && wall.getX()-headx>=0) || (this.headx-wall.getX()<=15 && this.headx-wall.getX()>=0))) {
